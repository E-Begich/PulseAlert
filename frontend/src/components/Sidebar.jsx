...
export default function Sidebar({ isOpen, toggleSidebar }) {
  ...
  return (
    ...
    >
      ...
      <button
        className="absolute bottom-4 left-1/2 -translate-x-1/2 w-10 h-10 flex items-center justify-center text-white bg-blue-700 hover:bg-blue-600 rounded-full shadow-lg md:hidden"
        onClick={toggleSidebar}  // <-- poziva funkciju iz roditelja
  ...
  return (
    <div
      className={`
        ...
        ${active ? "bg-blue-700/60 backdrop-blur-sm" : "hover:bg-blue-800/40"}
      `}
    >
      {icon}
      <span>{label}</span>
